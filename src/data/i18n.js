...
export const ui = {
  de: {
    htmlLang: 'de',
    brandSubline: 'Ganzheitliche Gesundheit',
    ...
    footerExtras: {
      audio: 'Audio-Raum',
      kinderbuch: 'Kinderbuch',
      krypto: 'Krypto verstehen',
      kryptoHinweis: 'Krypto-Hinweis',
      litepaper: 'Litepaper',
    },
    assistant: {
      toggle: 'Assistent',
      panelLabel: 'Callidus Assistent',
      title: 'Callidus Assistent',
      subtitle: 'Antwortet aus Callidus-Wissen und kuratierten Quellen.',
      close: 'Assistent schließen',
      questionLabel: 'Frage',
      placeholder: 'Frage zu Stress, Schlaf, Mikronährstoffen oder NEXUS',
      submit: 'Fragen',
      privacy: 'Keine Diagnose. Fragen werden zur Antwort an Firebase/Gemini übertragen.',
      greeting:
        'Frag mich zu Stress, Schlaf, Mikronährstoffen, Gesundheits-Wissen, Produkten, Videos, NEXUS, Valus (VAL), Krypto verstehen, Sport & Energie, dem Kinderbuch, dem Audio-Raum, dem Wissens-Quiz, dem Stress-Reset-Kurs (SRK) oder den Callidus-Artikeln. Ich antworte mit Quellen, wenn die Wissensbasis dazu etwas hergibt.',
      searching: 'Ich suche in der Callidus-Wissensbasis...',
      busy: 'Antwortet...',
      noAnswer: 'Ich konnte gerade keine Antwort erzeugen.',
      error: 'Der Assistent ist gerade nicht erreichbar. Bitte versuche es später erneut oder nutze die Quellen- und Check-Seiten.',
    ...
    paths: {
      ...
      compass: '/gesundheits-kompass/',
      checks: '/gesundheits-checks/',
      apps: '/nexus-app/',
      portal: '/portal/',
      nexus: '/nexus-app/',
      manual: '/handbuch/',
      lexicon: '/lexicon-vitae/',
      about: '/uber-uns/',
      faq: '/faq/',
      methodology: '/quellen-methodik/',
      wallet: '/wallet/',
      valus: '/valus/',
      privacy: '/datenschutz/',
      legal: '/impressum/',
    ...
    footer: 'Wissen für Wohlbefinden, bewusst und transparent.',
  ...
  en: {
    ...
    nav: {
      ...
      wallet: 'Wallet',
      audio: 'Audio',
      kinderbuch: "Children's books",
      valus: 'Valus',
    },
    footerExtras: {
      audio: 'Audio room',
      kinderbuch: "Children's books",
      krypto: 'Understanding crypto',
      kryptoHinweis: 'Crypto notice',
      litepaper: 'Litepaper',
    },
    assistant: {
      toggle: 'Assistant',
      panelLabel: 'Callidus Assistant',
      title: 'Callidus Assistant',
      subtitle: 'Answers from Callidus knowledge and curated sources.',
      close: 'Close assistant',
      questionLabel: 'Question',
      placeholder: 'Ask about stress, sleep, micronutrients, or NEXUS',
      submit: 'Ask',
      privacy: 'No diagnosis. Questions are sent to Firebase/Gemini to generate an answer.',
      greeting:
        'Ask me about stress, sleep, micronutrients, health knowledge, products, videos, NEXUS, Valus (VAL), understanding crypto, sport & energy, the children’s books, the audio room, the knowledge quiz, the Stress Reset course (SRK), or the Callidus articles. I answer with sources whenever the knowledge base supports it. Note: answers are currently provided in German.',
      searching: 'Searching the Callidus knowledge base...',
      busy: 'Answering...',
      noAnswer: 'I could not generate an answer right now.',
      error: 'The assistant is currently unavailable. Please try again later or use the sources and check pages.',
    ...
    footer: 'Knowledge for wellbeing, built with clarity and transparency.',
    socialLabel: 'Social media',
    legalLabel: 'Legal',
    legal: {
      imprint: 'Imprint',
...
export const homeCopy = {
  de: {
    title: 'callidus A&M: Ganzheitliche Gesundheit',
    description: 'Fundiertes Wissen für Körper, Geist und Seele. Ratgeber, Empfehlungen und App-Handbücher für ganzheitliches Wohlbefinden.',
    eyebrow: 'Health Intelligence',
    headline: 'Ein klarer Kompass für deine Gesundheit.',
    lede: 'Für alle, die zwischen Job und Familie gesünder leben wollen und keine Zeit haben, sich durch widersprüchliche Ratschläge zu wühlen. Wir ordnen ein, legen unsere Quellen offen und zeigen dir Schritte, die in deinen Alltag passen.',
    primaryCta: 'Gesundheits-Kompass starten',
    manualCta: 'App-Handbuch öffnen',
    nexusCta: 'NEXUS ansehen',
    kpiArticles: 'gesicherte Artikel und Seiten',
    kpiCategories: 'klare Themenbereiche',
    kpiImages: 'lokal gesicherte Bilder',
    orientationEyebrow: 'Orientierung',
    orientationHeadline: 'Alles findet seinen passenden Gesundheitsbereich.',
    contentLabel: 'Inhalte',
    selectionEyebrow: 'Auswahl',
    selectionHeadline: 'Gute Einstiege.',
    selectionText: 'Diese Artikel sind starke Startpunkte: Alltag, Darm, Atem, Energie, Zukunft und App-Nutzen.',
  ...
  en: {
    ...
    description: 'Evidence-informed knowledge for body, mind, and wellbeing. Guides, recommendations, and app manuals in one clear health hub.',
    eyebrow: 'Health Intelligence',
    headline: 'A clear compass for your health.',
    lede: 'callidus A&M brings health knowledge, practical routines, app support, and curated recommendations into a calm, fast, and logically structured knowledge hub.',
    primaryCta: 'Start the health compass',
    manualCta: 'Open app manual',
    nexusCta: 'View NEXUS',
    kpiArticles: 'archived articles and pages',
    kpiCategories: 'clear topic areas',
    kpiImages: 'locally archived images',
    orientationEyebrow: 'Orientation',
    orientationHeadline: 'Every topic has a clear health area.',
    contentLabel: 'items',
    selectionEyebrow: 'Selected reads',
    selectionHeadline: 'Strong starting points.',
    selectionText: 'These articles form useful entry points into the new site: daily life, gut health, breathing, energy, future health, and app support.',
...
export const guideCopy = {
  de: {
    title: 'Ratgeber für ganzheitliche Gesundheit | callidus A&M',
    description: 'Alle gesicherten Ratgeberartikel von callidus A&M, logisch nach Körper, Energie, Geist und Zukunft geordnet.',
    eyebrow: 'Ratgeber',
    headline: 'Wissen, das sich sortiert anfühlt.',
    lede: 'Dein Kompass für ganzheitliches Wohlbefinden: fundiertes Wissen rund um Naturheilkunde, Ernährung, Bewegung, mentale Balance und die Zukunft der Gesundheit.',
    articleLabel: 'Artikel',
    articleLabelPlural: 'Artikel',
    categoryCta: 'Kategorie-Seite ansehen',
  },
  en: {
    title: 'Holistic Health Guide | callidus A&M',
    description: 'The archived callidus A&M health articles, organized by body, energy, mind, and future health.',
    eyebrow: 'Guide',
...
export const categoryTranslations = {
  en: {
    'koerper-ernaehrung': {
      ...
      description: 'Nutrients, gut health, vitamins, and practical nutrition without dogma.',
    },
    'sport-energie': {
      title: 'Sport & Energy',
      description: 'Movement, strength, recovery, and small routines for more energy.',
    },
    'geist-seele': {
      title: 'Mind & Soul',
      description: 'Stress relief, mental resilience, gratitude, breathing techniques, and inner calm.',
    },
    'zukunft-gesundheit': {
      title: 'Future of Health',
      description: 'AI, longevity, personalized medicine, digital health, and emerging technologies.',
    },
  },
};
...
export function localizedPath(path, lang = 'de') {
  if (lang === 'en') {
    if (path === '/') return '/en/';
    if (path === '/ratgeber/') return '/en/guide/';
    if (path === '/handbuch/') return '/en/manual/';
    return path;
  }
  return path;
}
